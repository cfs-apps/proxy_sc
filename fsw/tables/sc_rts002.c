...
SC_RtsTable002_t SC_Rts002 = {
    ...
    /* 2 */
    .rts.hdr2.TimeTag = 5,
    .rts.cmd2         = CFE_MSG_CMD_HDR_INIT(SC_CMD_MID, SC_MEMBER_SIZE(cmd1), SC_NOOP_CC, SC_NOOP_CKSUM),

    /* 3 */
    .rts.hdr3.TimeTag = 5,
    .rts.cmd3         = CFE_MSG_CMD_HDR_INIT(SC_CMD_MID, SC_MEMBER_SIZE(cmd1), SC_NOOP_CC, SC_NOOP_CKSUM)};

...
//bc #include "sc_msgdefs.h"      /* defines SC command code values */
#include "sc_msgids.h"       /* defines SC packet msg ID's */
#include "sc_msg.h"          /* defines SC message structures */

#include "cfe_msg_hdr_proxy.h"  //bc
...
SC_AtsTable1_t SC_Ats1 = {
    ...
    .ats.cmd1 = CFE_MSG_CMD_HDR_INIT(SC_CMD_MID, SC_MEMBER_SIZE(cmd1), SC_NOOP_CC, SC_NOOP_CKSUM),

    /* 2 */
    .ats.hdr2.CmdNumber  = 2,
    .ats.hdr2.TimeTag_MS = SC_CMD2_TIME >> 16,
    .ats.hdr2.TimeTag_LS = SC_CMD2_TIME & 0xFFFF,
    .ats.cmd2       = CFE_MSG_CMD_HDR_INIT(SC_CMD_MID, SC_MEMBER_SIZE(cmd2), SC_ENABLE_RTS_CC, SC_ENABLE_RTS1_CKSUM),
    .ats.cmd2.RtsId = 1,
    ...
    .ats.cmd3       = CFE_MSG_CMD_HDR_INIT(SC_CMD_MID, SC_MEMBER_SIZE(cmd3), SC_START_RTS_CC, SC_START_RTS1_CKSUM),
    .ats.cmd3.RtsId = 1,

...
void SC_SendHkPacket(void)
{
    ...
    //bc CFE_SB_TimeStampMsg(&SC_OperData.HkPacket.TlmHeader.Msg);
    //bc CFE_SB_TransmitMsg(&SC_OperData.HkPacket.TlmHeader.Msg, true);
    CFE_SB_TimeStampMsg(CFE_MSG_PTR(SC_OperData.HkPacket.TlmHeader));
    CFE_SB_TransmitMsg(CFE_MSG_PTR(SC_OperData.HkPacket.TlmHeader), true);
}

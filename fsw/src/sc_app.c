...
CFE_Status_t SC_AppInit(void)
{
    ...
    //bc CFE_MSG_Init(&SC_OperData.HkPacket.TlmHeader.Msg, CFE_SB_ValueToMsgId(SC_HK_TLM_MID), sizeof(SC_HkTlm_t));
    CFE_MSG_Init(CFE_MSG_PTR(SC_OperData.HkPacket.TlmHeader), CFE_SB_ValueToMsgId(SC_HK_TLM_MID), sizeof(SC_HkTlm_t)); //BC
